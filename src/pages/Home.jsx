  ...
  return (
    <AnimatedPage>
      <section className="px-4 pt-8">
        ...
        <p className="mt-8">Born to Malayali parents but raised in Rajasthan, I was exposed to the cultures of both North and South India<span className="text-primary">*</span>.<br /><span className="text-[0.6rem] text-primary">[*Generally, these two don't get along much, but here I am]</span></p>
        ...
        <p>Well, that almost covers what you should know about me. Keep exploring my portfolio. Use the menu below to see other parts of the website.</p>
        </section>
      </section>
    </AnimatedPage>
  )
